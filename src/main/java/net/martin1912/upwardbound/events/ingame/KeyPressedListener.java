package net.martin1912.upwardbound.events.ingame;

import net.fabricmc.loader.api.FabricLoader;
import net.martin1912.upwardbound.events.init.AchievementListener;
import net.martin1912.upwardbound.events.init.KeyBindingListener;
